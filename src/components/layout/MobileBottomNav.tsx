...
import { LayoutDashboard, Truck, CalendarRange, Receipt, Users } from 'lucide-react';
...
const mobileNav = [
  ...
  { to: '/customers', label: 'Customers', icon: Users,           activeColor: 'text-emerald-600', activeBg: 'bg-emerald-100/80', glow: 'rgba(16,185,129,0.25)'  },
